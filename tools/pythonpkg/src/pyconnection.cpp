...
static void InitializeConnectionMethods(nb::class_<DuckDBPyConnection, shared_ptr<DuckDBPyConnection>> &m) {
	...
	m.def("read_json", &DuckDBPyConnection::ReadJSON, "Create a relation object from the JSON file in 'name'",
	      nb::arg("name"), nb::kw_only(), nb::arg("columns") = nb::none(), nb::arg("sample_size") = nb::none(),
	      nb::arg("maximum_depth") = nb::none(), nb::arg("records") = nb::none(), nb::arg("format") = nb::none(),
	...
	m.def("read_csv", &DuckDBPyConnection::ReadCSV, "Create a relation object from the CSV file in 'name'",
	      nb::arg("path_or_buffer"), nb::kw_only(), nb::arg("header") = nb::none(), nb::arg("compression") = nb::none(),
	      nb::arg("sep") = nb::none(), nb::arg("delimiter") = nb::none(), nb::arg("dtype") = nb::none(),
	      nb::arg("na_values") = nb::none(), nb::arg("skiprows") = nb::none(), nb::arg("quotechar") = nb::none(),
	      nb::arg("escapechar") = nb::none(), nb::arg("encoding") = nb::none(), nb::arg("parallel") = nb::none(),
	      nb::arg("date_format") = nb::none(), nb::arg("timestamp_format") = nb::none(),
	      nb::arg("sample_size") = nb::none(), nb::arg("all_varchar") = nb::none(),
	      nb::arg("normalize_names") = nb::none(), nb::arg("filename") = nb::none(),
	      nb::arg("null_padding") = nb::none(), nb::arg("names") = nb::none());
...
void DuckDBPyConnection::RegisterArrowObject(const nb::object &arrow_object, const string &name) {
	auto &connection = con.GetConnection();
	auto stream_factory =
	...
	if (DuckDBPyConnection::IsPandasDataframe(python_object)) {
		...
		if (IsPolarsDataframe(python_object)) {
			if (PolarsDataFrame::IsDataFrame(python_object)) {
				...
				nb::object materialized = python_object.attr("collect")();
		...
		auto pyrel = nb::cast<DuckDBPyRelation *>(python_object);
		...
		auto py_object_type = string(nb::str(python_object.get_type().attr("__name__")));
...
unique_ptr<DuckDBPyRelation> DuckDBPyConnection::ReadJSON(
    const string &name, const Optional<nb::object> &columns, const Optional<nb::object> &sample_size,
...
unique_ptr<DuckDBPyRelation> DuckDBPyConnection::ReadCSV(
    const nb::object &name_p, const nb::object &header, const nb::object &compression, const nb::object &sep,
    const nb::object &delimiter, const nb::object &dtype, const nb::object &na_values, const nb::object &skiprows,
    const nb::object &quotechar, const nb::object &escapechar, const nb::object &encoding, const nb::object &parallel,
    const nb::object &date_format, const nb::object &timestamp_format, const nb::object &sample_size,
    const nb::object &all_varchar, const nb::object &normalize_names, const nb::object &filename,
    const nb::object &null_padding, const nb::object &names_p) {
	...
	if (!nb::none().is(filename)) {
		if (!nb::isinstance<nb::bool_>(filename)) {
			throw InvalidInputException("read_csv only accepts 'filename' as a boolean");
		}
		bind_parameters["filename"] = Value::BOOLEAN(nb::bool_(filename));
	}
